...
module.exports = {"ActionBar":{"Items":[{"OnPress":"/MyCapexApplication/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel"},{"OnPress":"/MyCapexApplication/Rules/Capex/Capex_CreateEntity.js","Position":"Right","SystemItem":"Save"}]},"Caption":"Create Capex Detail","Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"description","_Name":"description","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"totalcost","KeyboardType":"Number","_Name":"totalcost","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"category_ID","AllowMultipleSelection":false,"AllowEmptySelection":true,"IsEditable":true,"IsPickerDismissedOnSelection":true,"IsSelectedSectionEnabled":true,"PickerItems":{"DisplayValue":"{name}","ReturnValue":"{ID}","Target":{"EntitySet":"Category","Service":"/MyCapexApplication/Services/service1.service"}},"_Name":"category_ID","_Type":"Control.Type.FormCell.ListPicker"},{"Caption":"BusinessPartner_BusinessPartner","AllowMultipleSelection":false,"AllowEmptySelection":true,"IsEditable":true,"IsPickerDismissedOnSelection":true,"IsSelectedSectionEnabled":true,"PickerItems":{"DisplayValue":"{BusinessPartner}","ReturnValue":"{BusinessPartner}","Target":{"EntitySet":"A_BusinessPartner","Service":"/MyCapexApplication/Services/service1.service"}},"_Name":"BusinessPartner_BusinessPartner","_Type":"Control.Type.FormCell.ListPicker"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Capex_Create","PrefersLargeCaption":true}
...
module.exports = {"Caption":"Capex","ActionBar":{"Items":[{"OnPress":"/MyCapexApplication/Actions/Capex/NavToCapex_Create.action","Position":"Right","SystemItem":"Add"}]},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false},"ObjectCell":{"AccessoryType":"disclosureIndicator","Description":"{totalcost}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/MyCapexApplication/Actions/Capex/NavToCapex_Detail.action","StatusImage":"","Title":"{ID}","Footnote":"{category_ID}","PreserveIconStackSpacing":false,"StatusText":"{BusinessPartner_BusinessPartner}","Subhead":"{description}","SubstatusText":""},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"Capex","Service":"/MyCapexApplication/Services/service1.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","ToolBar":{"Items":[{"_Name":"LogoutToolbarItem","_Type":"Control.Type.ToolbarItem","Caption":"Logout","OnPress":"/MyCapexApplication/Actions/Logout.action"}]},"_Name":"Capex_List","PrefersLargeCaption":true}
...
module.exports = {"DestinationName":"../service/MKCapexDemo1/","OfflineEnabled":false,"LanguageURLParam":"","OnlineOptions":{},"PathSuffix":"","SourceType":"Cloud","ServiceUrl":""}
